This is here so I don't forget how this works

Citadel - thing running on user workstation
Generator - the thing running on servers, in containers, dropboxes, implants, etc.

Reverse connection works by establishing a preexisting warm wireguard connection between a server behind NAT and a public one
