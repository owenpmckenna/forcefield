...
RUST_BACKTRACE=1 cargo +nightly build -Z build-std --release
cp ./target/release/generator ./testing/gen_1/forcefield_8080
cp ./target/release/forcefield ./testing/gen_2/forcefield_8080
cp ./target/release/forcefield ./testing/gen_3/forcefield_8080

echo "[+] copied generator. copying citadel..."

cp ./target/release/citadel ./testing/citadel/forcefield

echo "[+] copied citadel. building docker..."
